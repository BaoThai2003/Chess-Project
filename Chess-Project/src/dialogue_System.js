window.dialogueSystem = {
  ...
  showDialogue(enemyId, callback) {
    ...
    if (!dialogueScreen) {
      console.error("Dialogue screen not found!");
      if (callback) callback();
      return;
    }

    const enemyPortrait = document.getElementById("enemy-portrait");
    const enemyName = document.getElementById("dialogue-name");
  ...
  displayCurrentDialogue() {
    ...
    // Update name
    if (dialogueName) dialogueName.textContent = dialogue.speaker === "player" ? "Bao" : "Opponent";
